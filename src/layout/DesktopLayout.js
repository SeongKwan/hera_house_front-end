      ...
      return (
        ...
        >
                    ...
                    <div>
                      ...
                      <li className={cx("nav-item", "nav-item--archives")}>
                        <Link
                          to={`/archives`}
                          onClick={(e) => {
                            this._handleOnClickMainMenu(e, "Archives");
                          }}
                        >
                          ARCHIVES
                        </Link>
                        ...
                        <ul
                          className={cx("sub-nav", {
                            active: this.state.mainMenuIsOpened,
                          })}
                        >
                            ...
                            return (
                              ...
                              >
                                <Link
                                  ...
                                  onClick={(e) =>
                                    this._handleOnClickSubMenu(e, category.name)
                                  }
                                >
                                  {category.name}
                                </Link>
                                ...
                                {category.name === "Work" && (
                                  <ul
                                    className={cx("work-sub", {
                                      active: this.state.subMenuIsOpened,
                                    })}
                                  >
          ...
          <header className={cx({ borderless: this.props.borderless })}>
            ...
            <nav
              className={cx("home-nav", { "home-nav--mobile": width <= md })}
            >
              {/* md 사이즈 이상 (테스크톱 크기) */}
              {width > md && (
                <ul>
                  ...
                  >
                    ...
                    <ul
                      className={cx("sub-nav", {
                        active: this.state.selectedCategory === "work",
                      })}
                      onMouseLeave={(e) => this._handleOnMouseLeave(e, "sub")}
                    >
                      {mainCategories.map((category, i) => {
                        return (
                          <li
                            ...
                            onMouseOver={(e) =>
                              this._handleOnMouseOver(e, category.name)
                            }
                          >
                            <Link to={`/archives/${category.name}`}>
                              {category.name}
                            </Link>
                            {category.name === "Work" && (
                              <ul
                                className={cx("work-sub", {
                                  active:
                                    this.state.selectedSubCategory === "Work",
                                })}
                              >
                                {category.subCategories.map(
                                  (categoryWithSub, i) => {
