...
class LayoutAdminMain extends Component {
  ...
  _handleClickOnButtonLogout = () => {
    if (window.confirm("관리자님, 로그아웃 하실 건가요?")) {
      return this.props.authStore.logout().then((res) => {
      ...
      <div className={cx("LayoutAdminMain")}>
          ...
          <>
            <div className={cx("header")}>
              ...
              <div
                ...
                onClick={this._handleClickOnHamburgerMenu}
              >
            ...
            <div className={cx("hamburger-contents", { isOpened })}>
              ...
              <div
                className={cx("horizon-divider", "list-item-category")}
              ></div>

              <button
                className={cx("button-logout", "list-item-category")}
                onClick={this._handleClickOnButtonLogout}
              >
                로그아웃
              </button>
              <Link
        ...
        <aside className={cx("aside")}>
          ...
          <ul className={cx("list-category")}>
            ...
            <li className={cx("list-item-wrapper")}>
              <Link className={cx("list-item-category")} to={`${path}/post`}>
                게시물 관리
              </Link>
            </li>
            <li className={cx("list-item-wrapper")}>
              <Link className={cx("list-item-category")} to={`${path}/manual`}>
                사이트 사용설명서
              </Link>
            </li>
          </ul>
          <footer className={cx("footer")}>
            ...
            <Link className={cx("link-to-site")} to={`/`}>
              <FaLongArrowAltLeft className={cx("icon")} />
              <span>사이트로 돌아가기</span>
            </Link>
        ...
        <main className={cx("main")}>
          <div className={cx("div")}>{this.props.children}</div>
        </main>
      </div>
    );
  }
